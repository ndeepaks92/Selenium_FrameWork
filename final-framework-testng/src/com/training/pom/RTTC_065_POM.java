...
public class RTTC_065_POM {
	
	private WebDriver driver; 
	
	public RTTC_065_POM(WebDriver driver) {
		this.driver = driver; 
	...
	public String LoginPageTitle() {
		return this.LoginPageTitle.getText();
	}
	...
	public void EnterSearchField(String MetaTagTitle) {
		this.EnterSearchField.sendKeys(MetaTagTitle);;
		
	}
	
	
	@FindBy(xpath="//a[contains(text(),'Finger Ring TC065')]")
	private WebElement VerifyProduct;
	public boolean VerifyProduct() {
		return this.VerifyProduct.isDisplayed();
	}
